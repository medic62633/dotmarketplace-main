...
echo ""
echo " OxaPay webhook URL:"
echo "   https://${DOMAIN}/api/webhooks/oxapay"
echo ""
echo " If OXAPAY_SANDBOX=true in .env, payments are test-only."
echo " Set OXAPAY_SANDBOX=false when ready for live money."
echo "=============================================="
