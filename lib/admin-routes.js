function registerAdminRoutes(app, { authUser, store, sellerStore, paymentStore, withdrawalsCol, memory, listingsCol, usersCol, walletStore, inviteStore, portalAccess, stockStore, sellerProfilesCol, paymentsCol }) {
